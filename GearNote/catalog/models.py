...
class Prodotto(models.Model):
    ...
    prezzo = models.DecimalField(max_digits=10, decimal_places=2) # Fino a 99.999.999,99 €
    ...
    class Meta:
        ordering = ['-data_inserimento'] # Mostra prima i più recenti
...
def path_foto_prodotto(instance, filename):
    # Salva le foto in: media/prodotti/ID_prodotto/nome_file.ext
    return os.path.join('prodotti', str(instance.prodotto.id), filename)
